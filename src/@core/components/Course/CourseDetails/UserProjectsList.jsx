...
import GetCourseCommentsAdmin from "../../../Services/Api/CourseDetailsAdmin/GetCourseCommentsAdmin";
      ...
      return (
        <div className="d-flex justify-content-left align-items-center">
          ...
          <div className="d-flex flex-column">
            <span className="text-truncate">{row.author}</span>
          </div>
        </div>
      );
    },
...
const UserProjectsList = () => {
  ...
  const { courseComments, setCourseComments } = useMyCourseDetailstore();
